...
=== Read One
A `GET` request to lists one Server Role.
...
=== Read All
A `GET` request lists all Server Roles.
...
=== Create
A `POST` request to create Server Role.
...
=== Update
A `POST` request to update Server Role.
...
=== Delete
A `POST` request to delete Server Role.
