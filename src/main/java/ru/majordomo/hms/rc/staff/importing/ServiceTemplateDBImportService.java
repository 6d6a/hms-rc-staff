...
@Service
public class ServiceTemplateDBImportService {
    private final static Logger logger = LoggerFactory.getLogger(ServiceTemplateDBImportService.class);
    ...
    @Autowired
    public ServiceTemplateDBImportService(
